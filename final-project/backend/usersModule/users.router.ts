...
import { getAllUsers, getUser, putUser, signin_handler, signup_handler } from "./users.handlers";
...
userRouter.put("/", json(), multer({ dest: "uploads2/" }).single("image"), verifyTokenHandler, putUser);
